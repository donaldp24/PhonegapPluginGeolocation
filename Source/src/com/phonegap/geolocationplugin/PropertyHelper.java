...
public class PropertyHelper {
	 ...
	 ************************************************************************************************
	 */
	private final static String KEY_BOOTSERVICES = "com.phonegap.geolocationplugin.GeolocationPluginService.BootService";
	...
	private static void saveBootServices(Context context, String serviceList) {
        ...
        if (!serviceList.isEmpty())
        	Toast.makeText(context, "addBootService", Toast.LENGTH_SHORT).show();
        else
        	Toast.makeText(context, "removeBootService", Toast.LENGTH_SHORT).show();
	}
